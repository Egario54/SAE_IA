package Defi3.ia.framework.recherche;
...
import Defi3.ia.framework.common.State;
import Defi3.ia.framework.common.Action;
import Defi3.ia.framework.common.StateActionPair;
import Defi3.ia.framework.common.Misc;
...
*
*
* <p>Cette classe ajoute un ensemble détat et de transition à {@link SearchProblem}. Pour un exemple, voir la classe {@link Defi3.ia.problemes.Vacuum})</p>
*
*/
...
public abstract class Problem extends SearchProblem {
    ...
    /**
     * La liste des états a remplir (voir {@link Defi3.ia.problemes.Vacuum})
     */
    
    protected static State[] STATES = null ;

    /**
     * La liste des transitions a remplir (voir {@link Defi3.ia.problemes.Vacuum})
     */

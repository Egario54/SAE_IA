...
import Defi3.ia.framework.jeux.GameEngine;
import Defi3.ia.framework.jeux.Player;


import Defi3.ia.problemes.*;
    ...
    public static void main(String[] args){
        ...
        ArgParse.setUsage
            ("Utilisation :\n\n"
             ...
             + "[-v] [-h]\n"
             + "-game : Le nom du jeux {tic, c4}. Par défaut tic\n"
             + "-p1/2 : L'algorithme joueur {rnd, hum, minmax, alphabeta}. Par défault rnd pour les deux\n"
